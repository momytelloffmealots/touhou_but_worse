...
public class PlayerHealth : MonoBehaviour
{
    ...
    private void Die()
    {
        ...
        // Tắt ngay PlayerController và PlayerShooting khi chết
        foreach (var controller in GetComponents<PlayerController>())
        {
            controller.SetPlayerControl(false);
            controller.enabled = false;
        }

        foreach (var shooting in GetComponents<PlayerShooting>())
        {
